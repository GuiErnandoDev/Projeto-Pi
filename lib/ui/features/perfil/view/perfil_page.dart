...
/// Exibe e permite editar dados pessoais e de unidade consumidora.
class PerfilPage extends StatelessWidget {
  const PerfilPage({super.key});

  @override
  /// Monta a interface do perfil, mostrando dados do cliente e opções de edição.
  ...
  /// Widget exibido quando não há dados do cliente no Firestore.
  ...
  /// Card de cabeçalho com nome e email do cliente.
  ...
  /// Card de informações agrupadas (dados pessoais ou unidade).
  ...
  /// Tile de informação individual (ex: nome, telefone, etc).
